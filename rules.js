...
export const FiqhRules = {
    ...
    'maliki': {
        madhhab: 'maliki',
        version: '1.0',
        sourceKey: 'maliki_source',
        rules: {
            dynamicMaxHayd: true, // Requires user habit input
            minHaydMs: 0,                            // Even a drop is hayd
            maxHaydMs: 15 * 24 * 60 * 60 * 1000,     // Absolute max
            minTuhrMs: 15 * 24 * 60 * 60 * 1000,     // 15 days
            warningKey: "msg_hayd_warning_maliki"
        }
    },
    'hanbali': {
        madhhab: 'hanbali',
        version: '1.0',
        sourceKey: 'hanbali_source',
        rules: {
            minHaydMs: 24 * 60 * 60 * 1000,          // 24 hours (1 day)
            maxHaydMs: 15 * 24 * 60 * 60 * 1000,     // 15 days
            minTuhrMs: 13 * 24 * 60 * 60 * 1000,     // 13 days
            warningKey: "msg_hayd_warning_hanbali"
        }
    }
};
